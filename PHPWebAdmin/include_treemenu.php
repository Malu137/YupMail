...
if (hmailGetAdminLevel() == 0)
{
    ...
    $urlCom = htmlentities("index.php?page=compose&action=edit&accountid=" . $obAccount->ID . "&domainid=" . $obDomain->ID); 
    $dtree .= "d.add(" . $dtitem++ . ",0,'" . $accountaddress . "','$urlCom','','','" . "images/user.png','" . "images/user.png');\r\n";
}
