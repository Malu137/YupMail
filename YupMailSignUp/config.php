...
/*
 Modification that i have made is to run my YupMail application 
 Which is mdified version of PHPWebAdmin
*/
...
$hmail_config['rooturl']			= "http://localhost/YupMailSignUp/";
$hmail_config['YupMail'] = "http://localhost/YupMail/";
